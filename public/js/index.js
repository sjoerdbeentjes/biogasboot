...
},{"./transport":16,"./transports/index":17,"component-emitter":8,"debug":11,"engine.io-parser":23,"indexof":29,"parsejson":31,"parseqs":32,"parseuri":33}],16:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"./polling":20,"component-emitter":8,"component-inherit":9,"debug":11,"xmlhttprequest-ssl":22}],20:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":9,"debug":11,"engine.io-parser":23,"parseqs":32,"xmlhttprequest-ssl":22,"yeast":45}],21:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":16,"component-inherit":9,"debug":11,"engine.io-parser":23,"parseqs":32,"ws":6,"yeast":45}],22:[function(require,module,exports){
(function (global){
...
},{"./on":37,"./socket":38,"backo2":3,"component-bind":7,"component-emitter":8,"debug":11,"engine.io-client":13,"indexof":29,"socket.io-parser":41}],37:[function(require,module,exports){
...
},{"./on":37,"component-bind":7,"component-emitter":8,"debug":11,"parseqs":32,"socket.io-parser":41,"to-array":44}],39:[function(require,module,exports){
(function (global){
...
},{"./binary":40,"./is-buffer":42,"component-emitter":8,"debug":11,"has-binary2":26}],42:[function(require,module,exports){
(function (global){
...
},{"./modules/customer-dashboard":47,"./modules/real-time-graph":48,"./modules/real-time-tiles":49}],47:[function(require,module,exports){
'use strict';
...
if (document.querySelector('#chart')) {
  ...
  var containerWidth = parseInt(window.getComputedStyle(document.querySelector('#chart').parentNode).getPropertyValue('width'));
  var containerHeight = parseInt(window.getComputedStyle(document.querySelector('#chart').parentNode).getPropertyValue('height'));

  var margin = { top: 20, right: 30, bottom: 60, left: 30 };
  var width = containerWidth - margin.left - margin.right - 32;
  var height = containerHeight - margin.top - margin.bottom - 16;
  ...
  var yAxis = d3.axisLeft().ticks(10).tickSize(-width).scale(y);
